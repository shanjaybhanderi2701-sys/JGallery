...
dependencies {
    // The tab observes the cached index (spec §1 rule 4) and loads tiles ONLY as ThumbnailRequest
    ...
    implementation(project(":core:viewdefaults")) // seeds the per-tab sort/density from the app-wide default (APP-569).
